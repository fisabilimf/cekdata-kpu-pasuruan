...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div id="dataUbahTable" class="col-12" data-url="{{ route('apiUbah') }}" style="display: grid">
            </div>
        </div>
    </div>
</body>
...
<script>
    function editRow(ev, el) {
        window.location.href = '/admin/periksaDataUbah/' + el.getAttribute('data-id')
    }
    window.addEventListener('load', () => {
        const options = {
            tableElement: 'dataUbahTable',
            columns: {
                'nkk': {
                    label: 'NKK',
                    width: '5fr',
