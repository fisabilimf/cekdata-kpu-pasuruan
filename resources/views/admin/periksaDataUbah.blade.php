    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Perubahan Data</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Konfirmasi perubahan data</p>
            </div>
        </header>
        <!-- Contact Section-->
                ...
                <div class="row">
                    ...
                    <div class="row">
                        @foreach ($data->pendukung as $p)
                            <img class="img-fluid rounded mb-5" src="{{ $p->url }}" style="width: 200px"/>
                        @endforeach
                    </div>
                    <form action="{{ route('admin.terimaDataUbah', [$data->id]) }}" method="POST">
                        @csrf
                        <input class="btn btn-primary" type="submit" value="Terima">
                    </form>
                    <form action="{{ route('admin.hapusDataUbah', [$data->id]) }}" method="POST">
                        @csrf
