...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>Permintaan Data TMS</h1>
            </div>
        </div>
        <div class="row">
            <div id="dataTmsTable" class="col-12" data-url="{{ route('apiTms') }}" style="display: grid">
            </div>
        </div>
    </div>
</body>
...
<script>
    function editRow(ev, el) {
        window.location.href = '/admin/periksaDataTms/' + el.getAttribute('data-id')
    }
    window.addEventListener('load', () => {
        const options = {
            tableElement: 'dataTmsTable',
            columns: {
                'nkk': {
                    label: 'NKK',
                    width: '5fr',
