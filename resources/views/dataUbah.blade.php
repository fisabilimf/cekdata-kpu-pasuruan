...
<body>
    ...
    {{-- <h1>PENGAJUAN UBAH DATA</h1>
    <div class="container">
        <form action="{{ route('postDataUbah') }}" method="POST">
            @csrf
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <th>NKK</th>
                                <td>0
                                    <input type="text" name="nkk" value="{{ $data->nkk }}">
                                </td>
                            </tr>
                            <tr>
                                <th>NIK</th>
                            ...
                            <tr>
                                <th>TEMPAT LAHIR</th>
                                <td>
                                    <input type="text" name="tempat_l" value="{{ $data->tempat_l }}">
                                </td>
                            </tr>
                            <tr>
                                <th>TANGGAL LAHIR</th>
                                <td>
                                    <input type="text" name="tanggal_l" value="{{ $data->tanggal_l }}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>JENIS KELAMIN</th>
                                <td>
                                    <input type="text" name="jenkel" value="{{ $data->jenkel }}">
                                </td>
                            </tr>
                            <tr>
                                <th>JALAN / DUKUH</th>
                                <td>
                                    <input type="text" name="jln_dukuh" value="{{ $data->jln_dukuh }}">
                                </td>
                            </tr>
                            <tr>
                                <th>RT</th>
                            ...
                            <tr>
                                <th>DISABLITAS</th>
                                <td>
                                    <input type="text" name="disablitas" value="{{ $data->disablitas }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">PENGAJUAN UBAH DATA</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Silakan diisi sesuai dengan data yang ingin diubah.</p>
            </div>
        </header>
        <!-- Contact Section-->
    ...
    @if ($allowed)
        ...
        <div class="container">
            ...
            @endif
            <form action="{{ route('postDataUbah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="data_pemilih_id" value="{{ $data->id }}">
                <div class="row">
                    <div class="col-12">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th>NKK</th>
                                    <td>
                                        <input class="form-control" type="text" name="nkk" value="{{ $data->nkk }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>NIK</th>
                                ...
                                <tr>
                                    <th>TEMPAT LAHIR</th>
                                    <td>
                                        <input class="form-control" type="text" name="tempat_l" value="{{ $data->tempat_l }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>TANGGAL LAHIR</th>
                                    <td>
                                        <input class="form-control" type="text" name="tanggal_l" value="{{ $data->tanggal_l }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>STATUS PERNIKAHAN</th>
                                ...
                                <tr>
                                    <th>JENIS KELAMIN</th>
                                    <td>
                                        <input class="form-control" type="text" name="jenkel" value="{{ $data->jenkel }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>JALAN / DUKUH</th>
                                    <td>
                                        <input class="form-control" type="text" name="jln_dukuh" value="{{ $data->jln_dukuh }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>RT</th>
                        ...
                        <p>Sertakan Dokumen Bukti berupa foto yang sesuai dengan data yang anda ubah</p>
